...
namespace Gvr.Internal {
  /// <summary>
  /// The InstantPreview object uses the Instant Preview app to control the 
  /// main camera in a scene, and stream the contents of renderTexture
  /// back to the app. For more information, see the README.md file.
  /// </summary>
